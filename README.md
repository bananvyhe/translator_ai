...
- use `C:\cofex\translation\start_idle_translation.cmd` if you want idle-mining mode with automatic miner stop/start around translations and visible windows
